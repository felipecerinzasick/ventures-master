...
urlpatterns = [
    ...
    path('dashboard/stocks/', views.stocks_dashboard, name='stocks_dashboard'),
    path('dashboard/stocks/treasury/<slug:slug>/', views.treasury_stock_dashboard, name='treasury_stock_dashboard'),
